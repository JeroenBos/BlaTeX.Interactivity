...
// 	// const onEitherEndOfThis = intersection.compare(this.ptA) || intersection.compare(this.ptB);
// 	// const onEitherEndOfOther = intersection.compare(other.ptA) || intersection.compare(other.ptB);

// 	// if (onEitherEndOfThis && onEitherEndOfOther)
// 	// 	return false;
// 	// return intersection;
// }
